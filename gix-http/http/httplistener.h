...
/**
  ...
  The is_optional host parameter binds the listener to one network interface.
...
public:
    ...
    */
    HttpListener(ServerConfig *config, HttpRequestHandler* requestHandler, QObject* parent=nullptr);
