...
struct qt_meta_stringdata_ScintillaEdit_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScintillaEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScintillaEdit_t qt_meta_stringdata_ScintillaEdit = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ScintillaEdit"
...
static const uint qt_meta_data_ScintillaEdit[] = {
...
QT_INIT_METAOBJECT const QMetaObject ScintillaEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<ScintillaEditBase::staticMetaObject>(),
    qt_meta_stringdata_ScintillaEdit.data,
    qt_meta_data_ScintillaEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ScintillaEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScintillaEdit.stringdata0))
