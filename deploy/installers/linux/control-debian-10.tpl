...
Priority: optional
Architecture: amd64
Depends: qt5-default, libqt5xml5, libqt5xmlpatterns5, libqtermwidget5-0, libdwarf1, libelf++0, libdwarf++0, libmariadb-dev, libmariadb-dev-compat, libpq5, unixodbc
