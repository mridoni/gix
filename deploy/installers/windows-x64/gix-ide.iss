...
;Source: "{#WORKSPACE}\{#HOST_PLATFORM}\{#CONFIG}\gixsql.exe"; DestDir: "{app}\bin"; Flags: ignoreversion createallsubdirs recursesubdirs
...
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "ReleaseCompilerId"; ValueData: "gnucobol-3.1.2-std-vs-all"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "DebugCompilerId"; ValueData: "gnucobol-3.1.2-std-vs-all"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
; Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "ESQL_PreprocBinPath"; ValueData: "{app}\bin\gixsql.exe"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
; Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "ESQL_RuntimeLibPath"; ValueData: "{app}\bin\libgixsql.dll"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
; Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "ESQL_LinkLibPath"; ValueData: "{app}\bin\libgixsql.lib"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "editor_font_name"; ValueData: "Courier New"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: dword; ValueName: "editor_font_size"; ValueData: "9"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "grid_font_name"; ValueData: "MS Shell Dlg 2"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: dword; ValueName: "grid_font_size"; ValueData: "9"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: string; ValueName: "treeview_font_name"; ValueData: "MS Shell Dlg 2"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: dword; ValueName: "treeview_font_size"; ValueData: "9"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
Root: "HKCU"; Subkey: "Software\MediumGray\gix-ide"; ValueType: dword; ValueName: "default_eol_mode"; ValueData: "0"; Flags: createvalueifdoesntexist deletevalue uninsdeletevalue uninsdeletekeyifempty
