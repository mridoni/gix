...
#cd $WORKSPACE
#
#svn co file:///mnt/c/Repositories/gix-ide/trunk .
#if [ "$?" != "0" ] ; then
#	echo "Cannot checkout from file:///mnt/c/Repositories/gix-ide/trunk to $WORKSPACE/gix-ide"
#	exit 1
#fi
#rm .svn -fr
#------
...
export FINAL_OUTPUT_DIR=/mnt/c/inetpub/gix-download
