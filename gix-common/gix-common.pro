...
TEMPLATE = lib
TARGET = gix-common
INCLUDEPATH += . ./buildsystem ./projectsystem ./metadata ../libgixutils ../libgixpp ../libcpputils
...
linux:QMAKE_LFLAGS_DEBUG += -rdynamic -Wl,--whole-archive -lgixutils -lgixpp -lcpputils -Wl,--no-whole-archive
linux:QMAKE_CXXFLAGS_DEBUG += -O0 -std=c++17 -Wno-unknown-pragmas 

linux:QMAKE_LFLAGS_RELEASE+= -Wl,--whole-archive -lgixutils -lgixpp -lcpputils -Wl,--no-whole-archive
...
win32:QMAKE_LIBS = -lgixutils -lgixpp -lcpputils
