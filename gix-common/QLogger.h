...
namespace QLogger
{
     ...
     * @param message The message.
     */
    GIXCOMMON_EXPORT void QLog_Trace(const QString& module, const QString& message);
    /**
     * @brief Used to store Debug level messages.
     * @param module The module that the message references.
     * @param message The message.
     */
    GIXCOMMON_EXPORT void QLog_Debug(const QString& module, const QString& message);
    /**
     * @brief Used to store Info level messages.
     * @param module The module that the message references.
     * @param message The message.
     */
    GIXCOMMON_EXPORT void QLog_Info(const QString& module, const QString& message);
    /**
     * @brief Used to store Warning level messages.
     * @param module The module that the message references.
     * @param message The message.
     */
    GIXCOMMON_EXPORT void QLog_Warning(const QString& module, const QString& message);
    /**
     * @brief Used to store Error level messages.
     * @param module The module that the message references.
     * @param message The message.
     */
    GIXCOMMON_EXPORT void QLog_Error(const QString& module, const QString& message);
    /**
     * @brief Used to store Fatal level messages.
     * @param module The module that the message references.
     * @param message The message.
     */
    GIXCOMMON_EXPORT void QLog_Fatal(const QString& module, const QString& message);
     ...
     */
    class GIXCOMMON_EXPORT QLoggerManager : public QThread
    {
         Q_OBJECT
    ...
    public:
        ...
        static bool isConsoleEchoEnabled();
        static void setConsoleEchoEnabled(bool enabled);
    ...
    signals:
        void logMessage(QString, QString, LogLevel);
    ...
    private:
        ...
        static bool mConsoleEchoEnabled;
