...
linux:LIBS += -lScintillaEdit -L$(DESTDIR) -lgix-common -lgixsql -ldwarf
...
win32:HEADERS += ./CodeviewSymbolProvider.h ./GixDebuggerWin.h ./StackWalker.h
win32:SOURCES += ./CodeviewSymbolProvider.cpp ./GixDebuggerWin.cpp  ./StackWalker.cpp ./imagehlp_funcs.cpp
