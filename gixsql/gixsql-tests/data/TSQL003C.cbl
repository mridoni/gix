       ...
       WORKING-STORAGE SECTION. 
           ...
           01 CONN1-ID   PIC X(64).
           01 CONN2-ID   PIC X(64).
       ...
       000-CONNECT.
         ...
         MOVE 'CONN1' TO CONN1-ID.
         MOVE 'CONN2' TO CONN2-ID.
           ...
           EXEC SQL
              CONNECT TO :DATASRC-2 AS :CONN2-ID USER :DBUSR-2
           END-EXEC.   
      ...
      *    we test both types of disconnections
           ...
           EXEC SQL CONNECT RESET :CONN1-ID END-EXEC.
           EXEC SQL DISCONNECT :CONN2-ID END-EXEC.
