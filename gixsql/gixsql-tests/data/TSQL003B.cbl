      ...
      *     DISPLAY 'DROP(1): ' SQLCODE
      *     DISPLAY 'DROP(1): ' SQLERRMC(1:SQLERRML)
      *
      *     EXEC SQL AT CONN2 DROP TABLE IF EXISTS TAB2 END-EXEC.
      *     DISPLAY 'DROP(2): ' SQLCODE
      *     DISPLAY 'DROP(2): ' SQLERRMC(1:SQLERRML)
      *
      *     EXEC SQL AT CONN1 DROP TABLE IF EXISTS TAB2 END-EXEC.
      *     DISPLAY 'DROP(3): ' SQLCODE
      *     DISPLAY 'DROP(3): ' SQLERRMC(1:SQLERRML)
      *
      *     EXEC SQL AT CONN2 DROP TABLE IF EXISTS TAB1 END-EXEC.
      *     DISPLAY 'DROP(4): ' SQLCODE
      *     DISPLAY 'DROP(4): ' SQLERRMC(1:SQLERRML)
