...
namespace gixsql_tests
{
    [TestClass]
    [HostPlatform("x64")]
    [TestCategory("Misc Types")]
    public class TSQL008 : GixSqlTestBase
    {
        [TestInitialize]
        ...
        [TestMethod]
        [CobolSource("TSQL008A.cbl")]
        [GixSqlDataSource("pgsql", 1)]
        public void TSQL008A_MSVC_pgsql_x64_exe()
        {
        ...
        //public void TSQL008A_MSVC_mysql_x64_exe()
        //{
        //    compile(CompilerType.MSVC, "release", "x64", "exe");
        ...
        //[CobolSource("TSQL008A.cbl")]
        //[GixSqlDataSource("pgsql", 1)]
        //public void TSQL008A_MSVC_pgsql_x86_exe()
        //{
        ...
        //[CobolSource("TSQL008A.cbl")]
        //[GixSqlDataSource("mysql", 1)]
        //public void TSQL008A_MSVC_mysql_x86_exe()
        //{
        //    compile(CompilerType.MSVC, "release", "x86", "exe");
        ...
        public void TSQL008A_MinGW_pgsql_x64_exe()
        {
        ...
        public void TSQL008A_MinGW_mysql_x64_exe()
        {
            compile(CompilerType.MinGW, "release", "x64", "exe");
        ...
        [CobolSource("TSQL008A.cbl")]
        [GixSqlDataSource("pgsql", 2)]
        public void TSQL008A_MinGW_pgsql_x86_exe()
        {
        ...
        [CobolSource("TSQL008A.cbl")]
        [GixSqlDataSource("mysql", 2)]
        public void TSQL008A_MinGW_mysql_x86_exe()
        {
            compile(CompilerType.MinGW, "release", "x86", "exe");
